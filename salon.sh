...
#heading
echo -e "Welcome to R BEAUTY SALON, how can we assist you?\n"
...
then
  ...
  then
      ...
      echo -e "\nEnter a time you wish to book an appointment"
      read SERVICE_TIME
      ...
      echo "Great! I have put you down for a $GET_SERVICE_NAME at $SERVICE_TIME, $CUSTOMER_NAME."
  else
